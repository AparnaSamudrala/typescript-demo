...
interface Product {​​​​​
    ...
    const prodObject = {​​​​​productId: 1001, productName: 'Mobile'}​​​​;// declaring variable and invoking Product details function
    
    const productDetails: string = getProductDetails(prodObject); // line to populate the created product on console
